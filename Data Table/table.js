...
//                     actionCell.innerHTML = '<button class=" in btn btn-success" "onclick=invoice">Invoice</button>';
...
//                         // Redirect to invoice.html with customerId as a query parameter
//                         window.location.href = `invoice.html?id=${item.customerId}`;
//                     };
